...
namespace Xceed.Wpf.AvalonDock.Controls
{
    public abstract class LayoutItem : FrameworkElement
    {
        ...
        #region DirtyIndicator

        public static readonly DependencyProperty DirtyIndicatorProperty =
            DependencyProperty.Register("DirtyIndicator", typeof(Visibility), typeof(LayoutItem),
                new PropertyMetadata((System.Windows.Visibility.Collapsed),
                    null));

        public Visibility DirtyIndicator
        {
            get { return (Visibility)GetValue(DirtyIndicatorProperty); }
            set { SetValue(DirtyIndicatorProperty, value); }
        }
