    ...
    public class DockingManager : Control, IOverlayWindowHost//, ILogicalChildrenContainer
    {
        ...
        internal UIElement CreateUIElementForModel(ILayoutElement model)
        {
            ...
            if (model is LayoutDocumentPane)
            {
				...
				// Raise event to create the control automatically.
				if (null != OnDocumentPanelCreated)
				{
					OnDocumentPanelCreated(templateModelView);
				}
                ...
                if (e.NewItems != null)
                {
                    ...
                    foreach (var documentContentToImport in e.NewItems)
                    {
                        ...
                        if (!added)
                        {
                            ...
                            //documentPane.Children.Add(documentToImport);
							documentPane.SelectedContentIndex = -1;
		...
		public event Action<LayoutDocumentPaneControl> OnDocumentPanelCreated;

		#region PanelBorderThickness

		/// <summary>
		/// PanelBorderThickness Dependency Property
		/// </summary>
		public static readonly DependencyProperty PanelBorderThicknessProperty =
			DependencyProperty.Register("PanelBorderThickness", typeof(Thickness), typeof(DockingManager),
				new FrameworkPropertyMetadata(new Thickness(1)));

		/// <summary>
		/// Gets or sets the PanelBorderThickness property.  This dependency property 
		/// indicates the inner panel border thickness.
		/// </summary>
		public Thickness PanelBorderThickness
		{
			get { return (Thickness)GetValue(PanelBorderThicknessProperty); }
			set { SetValue(PanelBorderThicknessProperty, value); }
		}

		#endregion

		#region PanelBorderBrush

		/// <summary>
		/// PanelBorderBrush Dependency Property
		/// </summary>
		public static readonly DependencyProperty PanelBorderBrushProperty =
			DependencyProperty.Register("PanelBorderBrush", typeof(Brush), typeof(DockingManager),
				new FrameworkPropertyMetadata(Brushes.Gray));

		/// <summary>
		/// Gets or sets the PanelBorderBrush property.  This dependency property 
		/// indicates the inner panel border color.
		/// </summary>
