...
namespace Ron.WPF.Controls
{
        ...
        public bool UpgradeSettings
        {
            get
            {
                ...
                catch (Exception ex)
                {
                    ...
                    throw new AppsException(string.Format("The settings file seems to be corrupted"), ex);
                }
                return true;
            }
    ...
    public class WindowSettings
    {
        ...
        protected virtual void LoadWindowState()
        {
            ...
            {
                throw new AppsException("Failed to set the window state from the settings file", ex);
            }
        }
