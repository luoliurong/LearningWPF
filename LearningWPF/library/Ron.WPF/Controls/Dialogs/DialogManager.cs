...
namespace Ron.WPF.Controls.Dialogs
{
    ...
    public static class DialogManager
    {
        ...
        private static Window SetupExternalDialogWindow(BaseMetroDialog dialog)
        {
            ...
            try
            {
                win.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Ron.WPF;component/Styles/Controls.xaml") });
                win.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Ron.WPF;component/Styles/Fonts.xaml") });
                win.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Ron.WPF;component/Styles/Colors.xaml") });
