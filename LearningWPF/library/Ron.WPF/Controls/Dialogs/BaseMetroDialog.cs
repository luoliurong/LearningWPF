...
namespace Ron.WPF.Controls.Dialogs
{
    /// <summary>
    ...
    public abstract class BaseMetroDialog : ContentControl
    {
        ...
        /// <summary>
        /// Initializes a new Ron.WPF.Controls.BaseMetroDialog.
        /// </summary>
        ...
        private void Initialize([CanBeNull] MetroWindow owningWindow, [CanBeNull] MetroDialogSettings settings)
        {
            ...
            {
                this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Ron.WPF;component/Styles/Controls.xaml") });
            }

            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Ron.WPF;component/Styles/Fonts.xaml") });
            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Ron.WPF;component/Styles/Colors.xaml") });
            this.Resources.MergedDictionaries.Add(new ResourceDictionary { Source = new Uri("pack://application:,,,/Ron.WPF;component/Themes/Dialogs/BaseMetroDialog.xaml") });
